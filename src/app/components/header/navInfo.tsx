"use client";
import { BsCalendar4Week, BsChatLeft, BsPerson } from "react-icons/bs";

interface NavInfoProps {}

export const NavInfo = (props: NavInfoProps) => {
  return (
    <div className="h-14 w-full bg-gray-900">
      <div className="w-full max-w-7xl text-gray-50 lg:mx-auto md:px-4 px-2">
        <div className="columns-3 items-center">
          <div className="flex justify-start self-end items-center gap-2 text-xs h-14">
